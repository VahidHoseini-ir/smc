...
import ir.vahidhoseini.gmc.audio.MusicManager;
...
import ir.vahidhoseini.gmc.utility.LevelLoader;
import ir.vahidhoseini.gmc.view.AboutDialog;
import ir.vahidhoseini.gmc.view.Background;
import ir.vahidhoseini.gmc.view.ChoseLevelView;
import ir.vahidhoseini.gmc.view.ColorableTextButton;
import ir.vahidhoseini.gmc.view.GamepadMappingDialog;
import ir.vahidhoseini.gmc.view.GamepadSettingsDialog;
import ir.vahidhoseini.gmc.view.MusicButton;
...
public class MainMenuScreen extends AbstractScreen {
    ...
    @Override
    public void show() {
        MaryoGame.prefHandler.setTimeFor("ShowTimer");
        MaryoGame.prefHandler.setTimeFor("visible_timer");
        ...
        System.out.println("LOG: show method");
    ...
    public void resize(int width, int height) {
        ...
        System.out.println("LOG: resize method");
    ...
    public void hide() {
        ...
        System.out.println("LOG: hide method");
    ...
    public void pause() {
        MusicManager.pause();
        System.out.println("LOG: pause method");
    ...
    public void resume() {
        super.resume();
        System.out.println("LOG: resume method");
    ...
    public void dispose() {
        super.dispose();
        System.out.println("LOG: dispose method");
...
//            }
        ...
        playButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                if (MaryoGame.prefHandler.setTimeFor("BTN_PLAY_CLICKED")){
                    showLevels();
                }else{
        ...
        Label gameVersion = new Label("v" + MaryoGame.GAME_VERSION + " by simpilocity", skin, Assets
                .LABEL_BORDER25);
